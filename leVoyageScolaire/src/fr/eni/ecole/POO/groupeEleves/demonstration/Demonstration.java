...
import fr.eni.ecole.POO.groupeEleves.entite.BusException;
...
public class Demonstration {
	 ...
	 * d'exception
	 */
	private static void remplirBus() {
	 ...
	 */
	private static void listeDesPersonnesResponsables() {
		System.out.println("Liste des Personnes responsables dans le bus");
		bus1.afficherResponsables();
	}
	...
	private static void creerManeges() {
		...
		//System.out.println(chenille+ "Im here");
